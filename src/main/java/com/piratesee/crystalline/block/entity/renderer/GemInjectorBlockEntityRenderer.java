package com.piratesee.crystalline.block.entity.renderer;
...
public class GemInjectorBlockEntityRenderer implements BlockEntityRenderer<GemInjectorBlockEntity> {
	public GemInjectorBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
		
	}
	
	@Override
    public void render(GemInjectorBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
        ...
        switch (pBlockEntity.getBlockState().getValue(GemInjectorBlock.FACING)) {
